      ...
      <div className='row justify-content-center'>
        ...
        <div style={{ textAlign: 'center', margin: '20px 0' }}>
          {filteredProducts.length > 10 && !showAllProducts &&
            <button className='btn btn-primary mr-2' onClick={handleNextClick}>Next</button>
          }
          {showAllProducts &&
            <button className='btn btn-primary mr-2' onClick={handlePreviousClick}>Previous</button>
          }
          <AddProducts />
        </div>
      </div>
...
//               {reads ? (
//              filteredProducts.map((product) => (
//               <div  className='FilterProducts col-md-4 shadow p-3 mb-6 bg-body rounded mt-3 m-2'
//               style={{ width: '16rem' }}
//               data-aos='zoom-in'
//               key={product.id}>
//                      <div>
...
//              ) : (
//               'Read more...')}
//               {/* {reads ? filteredProducts : `${filteredProducts.substring(0, 30)}`} */}
//               </h5>
//               <button className='btn' onClick={() => setReads(!reads)}>{reads ? "Read less..." : "Read more..."}</button>
//             <AddProducts />
//           </div>
//              </div>
//       </div >
